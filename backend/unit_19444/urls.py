...
admin.site.site_header = "Unit"
admin.site.site_title = "Unit Admin Portal"
admin.site.index_title = "Unit Admin"

# swagger
api_info = openapi.Info(
    title="Unit API",
    default_version="v1",
    description="API documentation for Unit App",
)
